...
export const UsersList = () => {
  ...
  const SortIcon = ({ field }) => {
    ...
    return sortOrder === "asc" ? (
      <svg
        className="w-3.5 h-3.5 text-[#8d6f31]"
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
        ...
        <div className="mb-6">
          <div className="relative max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#8d6f31]/40 focus:border-[#8d6f31] transition"
            />
          </div>
        </div>
