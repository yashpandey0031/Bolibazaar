...
export const AdminDashboard = () => {
  ...
  const { mutate: assignCreditsMutation, isPending: assignLoading } =
    useAssignCredits();
                    ...
                    {(users || []).map((user) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          ...
                          <button
                            className="ml-2 text-xs bg-[#efe3c7] text-[#6a542f] px-2 py-1 rounded hover:bg-[#d7c9ab]"
                            onClick={() => {
            ...
            <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
              <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-md">
                <h3 className="text-lg font-semibold mb-4">
                  Assign Credits to {selectedUser.name}
                </h3>
                <input
                  type="number"
                  min="0"
                ...
                <div className="flex justify-end gap-2">
                  ...
                  <button
                    className="bg-[#8d6f31] text-white px-4 py-2 rounded"
                    disabled={assignLoading}
                    onClick={() => {
                      assignCreditsMutation(
                        { userId: selectedUser._id, credits: creditValue },
                        {
                          onSuccess: () => {
                            setAssigning(false);
                  ...
                  >
                    {assignLoading ? "Assigning..." : "Assign Credits"}
                  </button>
                </div>
              </div>
            </div>
