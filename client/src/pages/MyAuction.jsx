    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Link
            to="/create"
            className="inline-flex items-center gap-2 bg-[#8d6f31] text-white text-sm font-semibold px-5 py-2.5 rounded-xl hover:bg-[#6a542f] active:scale-[0.97] transition-all shadow-sm shadow-[#8d6f31]/20"
          >
            <svg
              className="w-4 h-4"
              fill="none"
              ...
              {categories.map((category) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${
                    filter === category
                      ? "bg-[#8d6f31] text-white shadow-sm"
        ...
        {pagination.totalPages > 1 && (
          <div className="flex items-center justify-center gap-2 mt-10">
            <button
              ...
              disabled={page === 1}
              className="px-4 py-2 text-sm font-medium rounded-xl border border-gray-200 bg-white text-gray-600 hover:border-[#d7c9ab] hover:text-[#8d6f31] disabled:opacity-40 disabled:cursor-not-allowed transition"
            >
              Previous
            </button>
              ...
              (p) => (
                <button
                  ...
                  className={`w-10 h-10 rounded-xl text-sm font-semibold transition ${
                    p === page
                      ? "bg-[#8d6f31] text-white shadow-sm"
                      : "bg-white text-gray-600 border border-gray-200 hover:border-[#d7c9ab] hover:text-[#8d6f31]"
                  }`}
                >
                  {p}
                </button>
