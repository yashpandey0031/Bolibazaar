            ...
            <div className="px-6 py-4">
              <div className="flex items-center justify-between">
                ...
                <div className="ml-4">
                  <button
                    disabled
                    className="px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-[#8d6f31] hover:bg-[#6a542f] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8d6f31] disabled:bg-[#cbbda0] cursor-not-allowed"
                  >
                    Enable
                  </button>
                </div>
            ...
            <div className="px-6 py-4">
              <div className="flex items-center justify-between">
                ...
                <div className="ml-4">
                  <Link
                    to="/profile"
                    className="px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-[#8d6f31]"
                  >
                    Change
                  </Link>
                </div>
