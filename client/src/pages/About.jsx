        ...
        <div className="bg-white rounded-sm shadow-sm p-8">
          ...
          <div className="prose max-w-none text-gray-700 leading-relaxed space-y-6">
            ...
            <section>
              ...
              <p>
                Bolibazaar is developed and maintained by <strong>Omkar</strong>{" "}
                and <strong>Yash</strong>, passionate full-stack developers
                dedicated to building modern, scalable web applications for
                real-world use.
              </p>
              ...
              <div className="mt-4 p-4 bg-gray-50 rounded-sm">
                ...
                <div className="space-y-2">
                  <p>
                    <span className="font-medium">Omkar GitHub:</span>{" "}
                    <a
                  ...
                  <p>
                    <span className="font-medium">Yash GitHub:</span>{" "}
                    <a
